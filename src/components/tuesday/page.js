...
export default function TuesdayNavbar() {
    ...
    <div className="">
      <div className="flex justify-between">
        <div className="flex gap-2">
          <span className="uppercase text-gray-400 font-bold">TUESDAY</span>
      ...
      <div className="">
        <div className="flex gap-2 mt-2">
          <div className="h-3 w-3 rounded-full bg-yellow-500 self-start mt-1"></div>
